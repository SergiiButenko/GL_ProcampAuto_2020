...
class API:
    ...
    """ contains base methods to work with the server API """

    @staticmethod
    def jwt_authenticate(credentials: dict) -> Response:
        """ Authenticates a user in the server with the credentials provided.
            Returns the server response from authentication
    ...
    def jwt_authorize(access_token) -> Response:
        """ Authorizes in the server with an access token passed as a parameter
    ...
    def create_resource(access_token: str, resource: dict) -> tuple:
        """ Creates a resource in the server. Returns server response and an id of the resource created.
    ...
    def read_resource(access_token: str, resource_id: str) -> tuple:
        """ Reads a resource by its id. Returns the server response, and the resource created content.
            :param access_token: jwt access token
    ...
    def delete_resource(access_token: str, resource_id: str) -> Response:
        """ Deletes a resource by its id. Returns the server response.
            :param access_token: jwt access token
            :param resource_id: resource id
